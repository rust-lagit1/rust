...
use crate::{self as ty, DebruijnIndex, Interner, TyDecoder, TyEncoder};
...
#[cfg(feature = "nightly")]
impl<I: Interner, E: TyEncoder<I = I>> rustc_serialize::Encodable<E> for UnsafeBinderInner<I>
where
...
#[cfg(feature = "nightly")]
impl<I: Interner, D: TyDecoder<I = I>> rustc_serialize::Decodable<D> for UnsafeBinderInner<I>
where
    ...
    I::BoundVarKinds: rustc_serialize::Decodable<D>,
{
    fn decode(decoder: &mut D) -> Self {
        ...
        UnsafeBinderInner(ty::Binder::bind_with_vars(Decodable::decode(decoder), bound_vars))
    }
}
